...
line1, = ax.plot(x, TF[0,:N].real, color="blue", label="Moja")
line2, = ax.plot(x, x/80, color="red")

def animate1(i):
    line1.set_ydata(TF[i,:N].real)  # update the data.
    line2.set_ydata(T_analit[i,:N].real)  # update the data.
    return line1, line2
...
ax.autoscale()
ax.set_title(r"Prikaz periodične difuzijske enačbe za Fourierovo metodo pri D="+str(D))
ax.set_xlabel(r'$x$')
ax.set_ylabel(r'$T(x)$')
...
ax.add_collection(lc)
ax.autoscale()
ax.set_title(r"Napake za Fourierovo metodo pri D="+str(D))
ax.set_xlabel(r'$x$')
ax.set_ylabel(r'$T(x)$')
axcb = fig.colorbar(lc)
axcb.set_label(r'$t$')
...
plt.xlabel("x")
plt.ylabel("T[K]")
plt.title(r"Prikaz periodične difuzijske enačbe za Fourierovo metodo pri D="+str(D))
plt.legend()
plt.show()
...
ax.add_collection(lc)
ax.autoscale()
ax.set_title(r"Prikaz homogene difuzijske enačbe za Fourierovo metodo pri D="+str(D))
ax.set_xlabel(r'$x$')
ax.set_ylabel(r'$T(x)$')
axcb = fig.colorbar(lc)
axcb.set_label(r'$t$')
...
ax.add_collection(lc)
ax.autoscale()
ax.set_title(r"Napake homogene difuzijske enačbe za Fourierovo metodo pri D="+str(D))
ax.set_xlabel(r'$x$')
ax.set_ylabel(r'$T(x)$')
axcb = fig.colorbar(lc)
axcb.set_label(r'$t$')
...
plt.xlabel("x")
plt.ylabel("T[K]")
plt.title(r"Prikaz homogene difuzijske enačbe za Fourierovo metodo pri D="+str(D))
plt.legend()
plt.show()
