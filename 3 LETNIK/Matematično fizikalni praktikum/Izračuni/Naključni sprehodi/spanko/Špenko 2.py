...
plt.plot(np.log(tdata4[0:count4]), np.log(MAD4[0:count4] ** 2),'o',color="black",)
plt.plot(r4, fitfunkcija(r4, par4[0], par4[1]),'-',color='red', label=str(par4[0]))
plt.title('Flight z zamikom pri paramterih $\mu=4$, N=1000')
plt.xlabel("ln[t]")
plt.ylabel("2ln[MAD]")
plt.legend()
plt.savefig('Flight z zamikom pri paramterih $mu=4$, N=1000 K=1000.png')
plt.show()

r3 = np.linspace(np.amax(np.log(tdata3[0:count3])), np.amin(np.log(tdata3[0:count3])))
plt.plot(np.log(tdata3[0:count3]), np.log(MAD3[0:count3] ** 2),'o',color="black",)
plt.plot(r3, fitfunkcija(r3, par3[0], par3[1]),'-',color='red', label=str(par3[0]))
plt.title('Walk z zamikom pri paramterih $\mu=4$, N=1000')
plt.xlabel("ln[t]")
plt.ylabel("2ln[MAD]")
plt.legend()
plt.savefig('Walk z zamikom pri paramterih $mu=4$, N=1000 K=1000.png')
plt.show()
...
plt.title('Flight pri paramterih $\mu=4$, N=1000')
plt.xlabel("ln[t]")
plt.ylabel("2ln[MAD]")
plt.legend()
plt.savefig('Flight pri paramterih $mu=4$, N=1000 K=1000.png')
plt.show()
...
plt.title('Walk pri paramterih $\mu=4$, N=1000')
plt.xlabel("ln[t]")
plt.ylabel("2ln[MAD]")
plt.legend()
plt.savefig('Walk pri paramterih $mu=4$, N=1000 K=1000.png')
plt.show()
