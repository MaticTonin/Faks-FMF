...
Euler10=izdelava_RK4(N,h,y_0)
y_main10=main_function(t10)

N=20 #KORAKI
h=lenght_T/N
t20=np.linspace(0,lenght_T, N)
Euler20=izdelava_RK4(N,h,y_0)

N=50 #KORAKI
h=lenght_T/N
t50=np.linspace(0,lenght_T, N)
Euler50=izdelava_RK4(N,h,y_0)

N=100 #KORAKI
h=lenght_T/N
t100=np.linspace(0,lenght_T, N)
Euler100=izdelava_RK4(N,h,y_0)

N=300 #KORAKI
h=lenght_T/N
t300=np.linspace(0,lenght_T, N)
Euler300=izdelava_RK4(N,h,y_0)

N=1000 #KORAKI
h=lenght_T/N
t1000=np.linspace(0,lenght_T, N)
Euler1000=izdelava_RK4(N,h,y_0)

N=5000 #KORAKI
h=lenght_T/N
t5000=np.linspace(0,lenght_T, N)
Euler5000=izdelava_RK4(N,h,y_0)
...
Euler10000=izdelava_RK4(N,h,y_0)

N=50000 #KORAKI
h=lenght_T/N
t50000=np.linspace(0,lenght_T, N)
Euler50000=izdelava_RK4(N,h,y_0)

N=100000 #KORAKI
h=lenght_T/N
t100000=np.linspace(0,lenght_T, N)
Euler100000=izdelava_RK4(N,h,y_0)

N=500000 #KORAKI
h=lenght_T/N
t500000=np.linspace(0,lenght_T, N)
Euler500000=izdelava_RK4(N,h,y_0)

N=1000000 #KORAKI
h=lenght_T/N
t1000000=np.linspace(0,lenght_T, N)
Euler1000000=izdelava_RK4(N,h,y_0)
...
plt.title('Prikaz približkov RK4 funkcije')
plt.xlabel("t")
plt.ylabel("T(t)")
plt.legend()
plt.show()
...
plt.plot(t1000,Euler1000,'-', label="N=1000")
plt.plot(t,y_main,'-', label="Dejanska funkcija")
plt.title('Prikaz približkov RK4 funkcije, približana')
plt.xlabel("t")
plt.ylabel("T(t)")
plt.axis([5,20, -5,10])
plt.legend()
...
plt.title('Prikaz približkov za RK4 metodo')
plt.xlabel("t")
plt.ylabel("Error(t)")
plt.legend()
plt.show()
...
plt.title('Prikaz približkov za RK4 metodo, več korakov')
plt.xlabel("t")
plt.ylabel("Error(t)")
plt.legend()
plt.show()
