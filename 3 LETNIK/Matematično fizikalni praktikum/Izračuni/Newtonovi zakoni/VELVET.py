...
#initial conditions
Verle05_theta=verlet(forcel,theta0,vtheta0,t05)
...
#initial conditions
Verle02_theta=verlet(forcel,theta0,vtheta0,t02)
...
#initial conditions
Verle01_theta=verlet(forcel,theta0,vtheta0,t01)
...
#initial conditions
Verle005_theta=verlet(forcel,theta0,vtheta0,t005)
...
#initial conditions
Verle001_theta=verlet(forcel,theta0,vtheta0,t001)
...
#initial conditions
Verle0005_theta=verlet(forcel,theta0,vtheta0,t0005)
...
#initial conditions
Verle0001_theta=verlet(forcel,theta0,vtheta0,t0001)
...
plt.title('Prikaz približkov Velvet za $\u03B8 (t)$')
plt.xlabel("t")
plt.ylabel("$\u03B8 (t)$ ")
...
plt.title('Prikaz približkov Velvet za $\dot{\u03B8} (t)$')
plt.xlabel("t")
plt.ylabel("$\u03B8 (t)$ ")
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.show()
...
plt.title('Prikaz napake Velvet za $\u03B8 (t)$')
plt.xlabel("t")
plt.ylabel("$\u03B8 (t)$ ")
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.show()