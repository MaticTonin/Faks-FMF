...
ax.plot(Tpp, Ep, color="black", marker=".", label="\\epsilon,vzporeden")
ax.plot(Tvv, Ev, color="red", marker=".", label="\\epsilon,pravokoten")
ax.plot(Tvv, E, color="blue", marker=".", label="\\epsilon,povprečen")
...
plt.savefig("Povprečni epsilon.png")
plt.show()
plt.close()
