...
my_file = os.path.join(THIS_FOLDER, "Upor-Temperatura,S.txt") 
...
plt.ylabel("R [Ohm]")
plt.legend()
plt.title("Graf odvisnosti upora od temperature, silicijev zastor")
plt.savefig("Upor-Temperatura,S.png")
plt.show()
