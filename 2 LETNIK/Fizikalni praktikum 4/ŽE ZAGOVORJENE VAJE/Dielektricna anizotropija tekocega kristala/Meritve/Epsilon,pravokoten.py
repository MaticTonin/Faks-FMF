...
my_file = os.path.join(THIS_FOLDER, "Epsilon,pravokoten.txt")
...
plt.legend()
plt.title("Odvisnost upora od temperature, pravokotno")
plt.savefig("Upor_temperatura, pravokotno.png")
plt.show()
plt.close()
...
#plt.axis([-1.7, 1.7, 0, 1])
plt.legend()
plt.title("Dielektrična konstanta v odvisnosti od temperature, pravokotno")
plt.savefig("Dielektričnost_temperatura, pravokotno.png")
plt.show()
plt.close()
