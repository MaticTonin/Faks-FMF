...
def je_permutacija(slovar):
    ...
    for key, value in slovar.items():
        if 1<= key <= n and 1<=value<=n:
            je_v_domeni[key-1]=True
            je_v_sliki[value-1]=True
        else:
            return False
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1NzA1fQ:1iJifb:PlMHwQg_agNDkfmtZhoW99pJDPs'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1NzA2fQ:1iJifb:GdumUC2V0lxXGQLSqvTsWqaMlgQ'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1NzA3fQ:1iJifb:A0X0Iylf_lfju_ltMCBhV5SnTLs'
        try:
            test_data = [
                ('cikel({1: 3, 2: 4, 3: 2, 4: 1}, 1)', [1, 3, 2, 4]),
                ('cikel({1: 3, 2: 2, 3: 1}, 1)', [1, 3]),
                ('cikel({1: 3, 2: 2, 3: 1}, 2)', [2]),
                ('cikel({1: 3, 2: 2, 3: 1}, 3)', [3, 1]),
            ]
            for td in test_data:
                if not Check.equal(*td):
                    break
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1NzA4fQ:1iJifb:CmZC_2G8vQkD6jAoC2pJ1Yxi36o'
        try:
            test_data = [
                ('cikli({1: 3, 2: 4, 3: 2, 4: 1})', [[1, 3, 2, 4]]),
                ('cikli({1: 3, 2: 2, 3: 1})', [[1, 3], [2]]),
                ('cikli({1: 3, 2: 5, 3: 2, 4: 1, 5: 4})', [[1, 3, 2, 5, 4]]),
                ('cikli({1: 3, 2: 1, 3: 2, 4: 5, 5: 4})', [[1, 3, 2], [4, 5]]),
            ]
            for td in test_data:
                if not Check.equal(*td):
                    break
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1NzA5fQ:1iJifb:lJYD7VmOr4JIkEwIia55q1aK9m4'
        try:
            test_data = [
                ('je_permutacija({1: 3, 2: 4, 3: 2, 4: 1})', True),
                ('je_permutacija({1: 3, 2: 2, 3: 2, 4: 1})', False),
                ('je_permutacija({1: 3, 2: 4, 4: 1})', False),
                ('je_permutacija({1: 3, 2: 5, 5: 1})', False),
            ]
            for td in test_data:
                if not Check.equal(*td):
                    break
