...
def pomnozi(recept,faktor):
    ...
    for sestavina, kolicina in recept.items():
        nov_recept[sestavina]= kolicina *faktor
    return nov_recept
...
def potrebno_kupiti(recept, shramba):
    seznam_nakupa={}
    for sestavine, kolicine in recept.items():
        razlika = kolicine- shramba.get(sestavine, 0)
        if razlika > 0:
            seznam_nakupa[sestavine]=razlika
    return seznam_nakupa
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1Njk4fQ:1iJif8:rotYKT315uhSV8DxqDS7AdmJiLo'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1Njk5fQ:1iJif8:InJin1PDK9M-tFxSYlfx2MQr2RY'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1NzAwfQ:1iJif8:5Mgw3NsOTspjJw6Tyf1NNTMbqjw'
        try:
            test_data = [
