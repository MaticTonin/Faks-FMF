...
def en_znakec_rot13(znak):
    n=ord(znak) #da vemo, kateri intiger ima
    if 64<n<91:
        d=n-64
        crka=91-d
        return chr(crka)
...
def na_datoteki_rot13(vhodna,izhodna):
    with open(izhodna,"w") as izhod:
        for vrstica in open(vhodna):
            print(rot13(vrstica.strip()), file=izhod) 
...
def desifriraj_rot13(sifrirano_besedilo):
    niz=rot13(sifrirano_besedilo)
    return niz
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1NjU0fQ:1iHx9L:IhXHt8LhzweyH5Pc2yZ2PRNkqXk'
        try:
            test_data = [
                ("en_znakec_rot13('A')", 'Z'),
                ("en_znakec_rot13('a')", 'z'),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1NjU1fQ:1iHx9L:WHWwZ8ocXptOpbnioLf1nesKTsM'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1NjU2fQ:1iHx9L:YTuesv_f6Y9yq0rv7JGEusyimyE'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTQ2LCJwYXJ0Ijo1NjU3fQ:1iHx9L:OsxxXNYaBMBlFRZUPqTMuSTSU6U'
        try:
            test_data = [
