...
filename=THIS_FOLDER+"\datafile.txt"
f = open(THIS_FOLDER+"\datafile.txt", "a") 
print ''
print ''
print "Started printing in "+str(filename)
print ''
print ''
f.write("R[kpc], delta_R[kpc], vc[km/s], delta_vc[km/s], wc[km/s/kpc], delta_wc[km/s/kpc], Reference")
f.write("\n")
for i in totallistvc:
    for j in i:
        f.write(str(j))
        f.write("\t")
    f.write("\n")
...
print ''
print ''
print "Done printing in file "+str(filename)
print ''
print ''
